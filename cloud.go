...
// getRaw returns the response body untouched.
//
// Needed for endpoints that serve a file rather than the usual JSON envelope —
// a kubeconfig, most obviously, which the caller writes to disk verbatim.
